 ...
 */
export declare function encrypt(nonce: Nonce, plaintext: Uint8Array, peerPublicKey: PublicKey, publicKey: PublicKey, privateKey: PrivateKey, aad: Uint8Array): Promise<Uint8Array>;
/**
 ...
 */
export declare function decrypt(encryption: Uint8Array, secretKey: PrivateKey): Promise<Decryption>;
export declare function nonce(): Nonce;
/**
